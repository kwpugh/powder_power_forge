...
{   
    ...
    public TreeAxeCustom(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder)
    {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add((new TranslationTextComponent("item.powder_power.tree_axe_trilium.line1").applyTextStyle(TextFormatting.GREEN)));			
	}
} 