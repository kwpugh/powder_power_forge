...
public class TokenJumpBoost extends Item
{
  ...
  @Override
	public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
	{
		...
		list.add(new StringTextComponent(TextFormatting.BLUE + "Provides player with Jump Boost"));
		list.add(new StringTextComponent(TextFormatting.RED + "Jump Boost ability active: " + EnableUtil.isEnabled(stack)));
