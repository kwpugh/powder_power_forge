	...
	public TokenFireResistance(Properties properties)
	{
		...
		{		
			if(entity instanceof PlayerEntity && !world.isRemote && EnableUtil.isEnabled(stack))
			{
				...
				player.addPotionEffect(new EffectInstance(Effects.FIRE_RESISTANCE, 260, 0, false, false));
			}
		}	
	  ...
	  public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand)
	  {
	      ...
	      if(!world.isRemote && player.isSneaking())
	      {
	          ...
	          player.sendMessage(new StringTextComponent("Fire Resistance ability active: " + EnableUtil.isEnabled(stack)));
	  ...
	  @Override
		public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
		{
			...
			list.add(new StringTextComponent(TextFormatting.RED + "Fire Resistance ability active: " + EnableUtil.isEnabled(stack)));
