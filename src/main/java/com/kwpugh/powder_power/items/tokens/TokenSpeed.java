...
public class TokenSpeed extends Item
{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand)
	{
		...
		if(!world.isRemote && player.isCrouching())
		{
			...
			player.sendMessage(new StringTextComponent("Speed ability active: " + EnableUtil.isEnabled(stack)));
  ...
  @Override
	public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
	{
		...
		list.add(new StringTextComponent(TextFormatting.BLUE + "Provides player with extra speed"));
		list.add(new StringTextComponent(TextFormatting.RED + "Speed ability active: " + EnableUtil.isEnabled(stack)));
