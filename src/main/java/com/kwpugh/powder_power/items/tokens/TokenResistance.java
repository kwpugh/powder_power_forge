...
public class TokenResistance extends Item
{
	public TokenResistance(Properties properties)
	{
		super(properties);
	}
  ...
  @Override
	public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
	{
		...
		list.add(new StringTextComponent(TextFormatting.BLUE + "Provides player with extra attack damage resistance"));
		list.add(new StringTextComponent(TextFormatting.RED + "Resistance ability active: " + EnableUtil.isEnabled(stack)));
