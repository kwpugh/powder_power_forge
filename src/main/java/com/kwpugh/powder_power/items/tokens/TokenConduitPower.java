...
public class TokenConduitPower extends Item
{
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand)
	{
		...
		if(!world.isClientSide && player.isShiftKeyDown())
		{
			...
			player.displayClientMessage(Component.translatable("item.powder_power.token_conduit_power.line2", EnableUtil.isEnabled(stack)).withStyle(ChatFormatting.BOLD), true);
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
	{
		...
		tooltip.add((Component.translatable("item.powder_power.token_conduit_power.line1").withStyle(ChatFormatting.GREEN)));
		tooltip.add((Component.translatable("item.powder_power.token_conduit_power.line2", EnableUtil.isEnabled(stack)).withStyle(ChatFormatting.RED)));
