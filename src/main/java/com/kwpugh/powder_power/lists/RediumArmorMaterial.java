...
{
    private static int durabilityMultiplier = ConfigPowderPower.REDIUM_ARMOR_DURABILITY_MULTIPLIER.get();
    private static int enchantability = ConfigPowderPower.REDIUM_ARMOR_ENCHANTABILITY.get();
    private static double toughness = ConfigPowderPower.REDIUM_ARMOR_TOUGHNESS.get();
    private static double knochback = ConfigPowderPower.REDIUM_ARMOR_KNOCKBACK_RESISTANCE.get();
