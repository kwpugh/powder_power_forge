...
public class ToolMaterialTiers
{
    ...
    private static int triliumMiningLevel = 5;
    ...
    private static int quadriliumMiningLevel = 5;
    private static int quadriliumEnchantability = ConfigPowderPower.QUADRILIUM_TOOL_ENCHANTABILITY.get();


    public static final Tier OBSIDIAN = new ForgeTier(obsidianMiningLevel, obsidianDurability, (float) obsidianEfficiency, (float) obsidianAttackDamage, obsidianEnchantability,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemInit.INGOT_OBSIDIAN.get()));

    public static final Tier PRISMARINE = new ForgeTier(prismarineMiningLevel, prismarineDurability, (float) prismarineEfficiency, (float) prismarineAttackDamage, prismarineEnchantability,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemInit.INGOT_PRISMARINE.get()));

    public static final Tier REDIUM = new ForgeTier(rediumMiningLevel, rediumDurability, (float) rediumEfficiency, (float) rediumAttackDamage, rediumEnchantability,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemInit.INGOT_REDIUM.get()));

    public static final Tier LAPIUM = new ForgeTier(lapiumMiningLevel, lapiumDurability, (float) lapiumEfficiency, (float) lapiumAttackDamage, lapiumEnchantability,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemInit.INGOT_LAPIUM.get()));

    public static final Tier GEMIUM = new ForgeTier(gemiumMiningLevel, gemiumDurability, (float) gemiumEfficiency, (float) gemiumAttackDamage, gemiumEnchantability,
            Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemInit.GEM_GEMIUM.get()));

    public static final Tier TRILIUM = new ForgeTier(triliumMiningLevel, triliumDurability, (float) triliumEfficiency, (float) triliumAttackDamage, triliumEnchantability,
            Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemInit.INGOT_TRILIUM.get()));

    public static final Tier QUADRILIUM = new ForgeTier(quadriliumMiningLevel, quadriliumDurability, (float) quadriliumEfficiency, (float) quadriliumAttackDamage, quadriliumEnchantability,
