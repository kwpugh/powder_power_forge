...
public class AnvilEventHandler
{
	...
	public static void upgradeSomeTools(AnvilUpdateEvent event)
	{
		...
		{			
			...
			output.setHoverName(Component.translatable("Improved Obsidian Pickaxe"));
			event.setCost(10);
		...
		{			
			...
			output.enchant(Enchantments.BLOCK_EFFICIENCY, 1);
			output.setHoverName(Component.translatable("Improved Prismarine Pickaxe"));
			event.setCost(10);
			event.setOutput(output);
		}
		...
		{			
			...
			output.setHoverName(Component.translatable("Deadly Prismarine Dagger"));
			event.setCost(10);
			event.setOutput(output);
		}
		...
		{			
			...
			output.enchant(Enchantments.SHARPNESS, 1);
			output.enchant(Enchantments.MOB_LOOTING, 1);
			output.setHoverName(Component.translatable("Deadly Diamond Sword"));
			event.setCost(20);
			event.setOutput(output);
		}
		...
		{			
			...
			output.setHoverName(Component.translatable("Improved Diamond Pickaxe"));
			event.setCost(20);
			event.setOutput(output);
		}
		...
		{			
			...
			output.setHoverName(Component.translatable("Deadly Quadrilirite Sword"));
